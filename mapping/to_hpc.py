"""Map canonical data to HPC Excel schema."""
...
def canonical_to_hpc_row(c: CanonicalRow) -> Dict[str, Any]:
    """Convert a CanonicalRow to HPC Excel row format.
    ...
    BBD field is not included (Food-only).
    """
    return {
        ...
        "Price/Unit (Euro)": c.get("price_unit_eur"),  # ✅ Extract from canonical
    }